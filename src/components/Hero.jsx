...
const Hero = () => {
    ...
    return (
        <div className="bg-hero lg:bg-center bg-right lg:bg-full bg-cover xl:h-[810px] lg:h-[668px] sm:h-[878px]">
            <NavBar />
            <div className='md:py-[115px] py-[56px]'>
                <div className="max-w-[1180px] px-5 relative mx-auto">
                    <div className="flex flex-col">
                        <div className="flex items-center lg:items-start flex-col">
                            ...
                            <div className='flex max-lg:justify-between bg-light-white md:p-[9px_9px_9px_20px] p-[6px_6px_6px_10px] max-w-[476px] w-full rounded-[0_100px_100px_55px] border border-solid border-pale-grey'>
                                ...
                                <button onClick={validateAddress} aria-label="contact us" className='flex max-lg:justify-between items-center duration-500  gap-[3px] font-bold text-base leading-115 hover:bg-black text-white bg-sky-blue w-full sm:max-w-[137px] max-w-[128px] py-[12px] md:ps-5 ps-3 md:pe-[3px] pe-3 rounded-[0_50px_50px_20px]'>Compare
                        ...
                        <div className="relative z-[2] lg:hidden max-lg-image sm:mt-20 mt-10">
                            ...
                            />
                            <div className="absolute  top-[-73px] lg:right-[-39px] sm:right-[57px] right-[-5px] z-[-1]">
                                <Image
                    ...
                    <div className="absolute top-[-13px] right-0 lg:pr-5 hidden lg:block">
